...
<div align="center">
  ...
  <h1>togo-framework/notifications</h1>
  <p>
    <a href="https://to-go.dev/marketplace"><img src="https://img.shields.io/badge/marketplace-to--go.dev-1FC7DC" alt="marketplace" /></a>
    <a href="https://pkg.go.dev/github.com/togo-framework/notifications"><img src="https://pkg.go.dev/badge/github.com/togo-framework/notifications.svg" alt="pkg.go.dev" /></a>
...
Laravel-style notifications for [togo](https://github.com/togo-framework/togo).
Channels: **mail** (via togo mail), **broadcast** (via togo realtime), **database**.
Push providers (FCM, OneSignal, Pusher) ship as channel plugins.
